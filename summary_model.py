...
def youtube_summarization(yt_transcript: str, llm_name: str, key: str, lang: str) -> str:
    ...
    """
    matter = "youtube video transcription, provides a summary of the video's key points, main ideas, and relevant information, here is the youtube video transcription"
    llm, context_length = llm_choice(llm_name, key, "sum")
